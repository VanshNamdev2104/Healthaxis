...
const EditDoctorModal = ({ isOpen, onClose, onSubmit, doctor, isLoading }) => {
  const modalRef = useRef(null);
  const overlayRef = useRef(null);
  const [form, setForm] = useState({
    name: "", email: "", contact: "", specialization: "", experience: "", fee: 0
  });
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
      ...
      >
        <div className="bg-[#f6fafe] px-10 py-8 border-b border-white/50 flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-black text-[#171c1f] tracking-tight">Edit Professional</h2>
            <p className="text-[#6c7a71] text-xs font-bold uppercase tracking-widest mt-1">Lumina Clinical Record Manager</p>
          </div>
